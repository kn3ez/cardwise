...
const CARDS_DB = [
  ...
  buildCard({
    ...
    perks: [
      ...
      { id: 'ap-clear', name: '$189 CLEAR Plus Credit', value: 189, frequency: 'annual', description: 'Statement credit for CLEAR Plus membership' },
      { id: 'ap-entertainment', name: '$240 Digital Entertainment Credit', value: 240, frequency: 'monthly', monthlyValue: 20, description: '$20/mo — Disney+, Hulu, ESPN+, Peacock, Audible, NYT' },
      ...
      { id: 'ap-global-entry', name: 'Global Entry / TSA PreCheck Credit', value: 100, frequency: 'annual', description: 'Up to $100 every 4-5 years' },
